...
for bucket in buckets:
    ...
    # URL path format: /o/uploads%2Ftest_txt_file.txt?uploadType=media
    url = f"https://firebasestorage.googleapis.com/v0/b/{bucket}/o/{encoded_path}?uploadType=media"
    data = b"Hello from Pooja Productions Correct URL format!"
